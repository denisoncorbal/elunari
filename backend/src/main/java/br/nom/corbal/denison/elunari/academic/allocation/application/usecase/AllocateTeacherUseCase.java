package br.nom.corbal.denison.elunari.academic.allocation.application.usecase;
...
import br.nom.corbal.denison.elunari.academic.allocation.application.event.AllocationEventPublisher;
import br.nom.corbal.denison.elunari.academic.allocation.application.mapper.AllocationMapper;
import br.nom.corbal.denison.elunari.academic.allocation.domain.event.TeacherAllocatedEvent;
...
public class AllocateTeacherUseCase implements BaseUseCase<UUID, AllocateTeacherCommand> {
    ...
    public UUID execute(AllocateTeacherCommand allocateTeacherCommand) {
        ...
        AllocationAggregate allocation = AllocationMapper.toAllocationAggregate(allocateTeacherCommand);
